...
document.addEventListener('DOMContentLoaded', () => {
    const enterButton = document.querySelector('.btn.btn--primary');
    if (enterButton) {
        enterButton.addEventListener('click', () => {
            console.log('Enter button clicked');
            
            
            // Show navigation with animation and add background
            ...
            if (nav) {
                ...
                console.log('Background class added:', document.body.classList.contains('show-background'));
                console.log('Current background-image:', window.getComputedStyle(document.body).backgroundImage);
            ...
            <div class="manifesto reveal">
                ...
                <div class="intro-text reveal" style="animation-delay: 0.3s">
                    ...
                    <p class="manifesto-text">Born from the mind of Dr. O, Psych Ward Blend definitely has some interesting effects. Whether you're chasing your next big idea or simply surviving the grind, we've got the brew to keep you on your toes.</p>
